...
const Navbar = () => {
    return <nav className="mb-20 flex items-center justify-between py-6 bg-transparent">
        <div className="flex items-center pl-4">
            <img src={logo_av} alt="Logo Arthur" className="mx-2 h-32 transition-all duration-500 hover:scale-150" />
        </div>
